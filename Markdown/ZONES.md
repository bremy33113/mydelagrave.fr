...
### MobilePlanning.tsx (pmpo - Page Mobile Poseur)

```
┌──────────────────────────────────────┐
│ 🏢 │ Mon Planning            │ 🚪    │
├──────────────────────────────────────┤
│    ◀  Semaine 2 (6-12 jan)  ▶       │  ← Navigation S-∞ à S+2
├──────────────────────────────────────┤
│ ═══ Lundi 6 janvier ═══════════════  │
│ ┌────────────────────────────────┐   │
│ │ 1.1 Préparation site           │   │
│ │ CHU Nantes                     │   │
│ │ 8h → 12h (4h)                  │   │
│ │ [📞 Appeler] [🗺️ GPS]          │   │
│ └────────────────────────────────┘   │
...
└── pages/
    ...
    │
    └── mobile/             # 📱 NOUVEAU v1.4.0
        ├── MobileChantiersList.tsx  # Liste chantiers CA (pmca)
        └── MobilePlanning.tsx       # Planning semaine poseur (pmpo)
```
